THEME_ORDER = [:eclipse, :clouds, :github,
               :tomorrow, :ambiance, :dracula,
               :gruvbox, :monokai, :twilight]
THEMES = {
    :eclipse  => {:ace => 'Eclipse' , :bg => '#ffffff', :fg => '#444444', :ld => 'l'},
    ...
    :twilight => {:ace => 'Twilight', :bg => '#112233', :fg => '#eeeeee', :ld => 'd'},
}
